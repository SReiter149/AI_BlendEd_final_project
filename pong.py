...
class Ball:
    ...
    def check_collision(self, paddles):
        ...
        for num, paddle in enumerate(paddles):
            ...
            if (
                self.position[0] - self.size <= paddle.position[0]
...
class game:
    ...
    def __init__(self, view=True):
        ...
        self.BALL_SIZE = 7
        self.ball = Ball(
            self.screen, start_position=self.BALL_START, size=self.BALL_SIZE
        )
    ...
    def get_state(self):
        ...
        # creates state
        state1 = [
            self.paddle1.position[0],
            self.paddle1.position[1],
        ...
        state2 = [
            self.paddle1.position[0],
            self.paddle1.position[1],
            self.SCREEN_WIDTH - self.ball.position[0],
            self.SCREEN_HEIGHT - self.ball.position[1],
            -1 * self.ball.direction[0],
            self.ball.direction[1],
        ]
    ...
    def reset(self):
        ...
        self.paddle1 = Paddle(
            self.screen,
            start_position=[self.PADDLE_OFFSET, 0],
            paddle_size=self.PADDLE_SIZE,
        )
        self.scores = [0, 0]
